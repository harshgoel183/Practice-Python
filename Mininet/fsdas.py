...
start = "curl -X POST -d  "
ends1 = "http://localhost:8080/firewall/module/rules/0000000000000001"
ends2 = "http://localhost:8080/firewall/module/rules/0000000000000002"
h1 = "\"10.0.0.1/32\""
h2 = "\"10.0.0.2/32\""
switch = ""
s = ""
    ...
    if commandLine.startswith('block'):
        ...
        if b[1] != "-s" or b[3] != "-d":
            ...
            if b[5] == "s1":
                ...
                switch = ends2
            if len(b) == 6:
                final = start + '\'{"new_src": ' + s + ', "nw_dst": ' + d +', "actions": "DENY"' +'}\' ' + switch
                #print(final)
                ...
                prot = b[7].upper()
                final = start + '\'{"new_src": ' + s + ', "nw_dst": ' + d + ', "nw_proto": ' + '\"' + prot + '\"' +', "actions": "DENY"'+ '}\' ' + switch
                #print(final)
